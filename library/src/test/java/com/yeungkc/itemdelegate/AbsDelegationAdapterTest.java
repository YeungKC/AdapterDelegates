...
public class AbsDelegationAdapterTest {
  ...
  @Test public void checkDelegatesManagerInstance() {
    ...
    final ItemDelegatesManager<Object> manager = new ItemDelegatesManager<>();
  ...
  @Test public void callAllMethods() {
    ...
    SpyableItemDelegate<Object> delegate1 = new SpyableItemDelegate<Object>(0);
    SpyableItemDelegate<Object> delegate2 = new SpyableItemDelegate<Object>(1);
    ItemDelegatesManager<Object> manager =
        new ItemDelegatesManager<>()
