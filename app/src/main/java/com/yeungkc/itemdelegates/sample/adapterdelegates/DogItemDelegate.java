...
import com.yeungkc.itemdelegates.sample.model.Dog;
import java.util.List;

/**
 * @author Hannes Dorfmann
 */
public class DogItemDelegate extends ItemDelegate<List<DisplayableItem>> {

  private LayoutInflater inflater;

  public DogItemDelegate(Activity activity) {
