...
import com.yeungkc.itemdelegates.sample.model.Cat;
 ...
 */
public class CatItemDelegate extends ItemDelegate<List<DisplayableItem>> {

  private LayoutInflater inflater;

  public CatItemDelegate(Activity activity) {
