...
import com.yeungkc.itemdelegates.sample.model.Advertisement;
 ...
 */
public class AdvertisementItemDelegate extends ItemDelegate<List<DisplayableItem>> {

  LayoutInflater inflater;

  public AdvertisementItemDelegate(Activity activity) {
